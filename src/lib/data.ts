...
export const experiences = [
  {
    ...
    points: [
      ...
      "Designed and built the IsoPerf performance testing framework end-to-end for Arkham GraphQL — adopted platform-wide for data-driven feature rollout decisions",
      "Diagnosed and resolved a critical memory leak in arkham-session that persisted for over two years, presenting root cause analysis to North America Services leadership",
      "Led AWS CloudWatch Synthetic Canaries initiative from POC through team-wide adoption across US, Japan, and India teams",
      "Expanded platform observability across Arkham GraphQL with service metrics, Grafana dashboards, and LTIE/LTIP resiliency framework integration",
    ],
